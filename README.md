...
<h3 align="center">It's my professional Github for my workspace. I'm currently working with a high aspiration with Solvrz as an AI-Backend developer. My task is to research and develop various software based on new problems. I'm a fast learner. I take agile approach to learn and build software. So far I've used Flask Restful APIs for integrating AI services, I've also worked with Streamlit for front end using python, Fast API for backend developent, . I've a high aspiration to work with Solvrz so that it might one day become a great RND software industry. </h3>

<h3 align="center">here have a look at Solvrz. I've developed the chatbot in this Solvrz Website too.</h3>
